...
const UpdateForm = ({id, uIstate, cb, administrationId, setId}) => {
  ...
  const handleSubmit = (e, id) => {
    e.preventDefault();
    const employers = updateById(uIstate, id, values, administrationId);
    cb([employers]);
  };
  return(
    <tr>
...
const updateById = (state, id, values, administrationId) => {
